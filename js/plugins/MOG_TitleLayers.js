...
/*:
 * @target MZ
 * @plugindesc (v1.3) Adiciona multiplas camadas na tela de título.
 * @author Moghunter
 ...
 * * HISTORICO
 * =============================================================================
 * (v1.3) - Correção da opção de não ativar o texto do título funcionar.
...
Scene_Title.prototype.createCommandWindow = function() {
	...
	var ttext = String(Moghunter.titleText) == "true" ? true : false;
    if (ttext) {this.createTitleText()};
};
